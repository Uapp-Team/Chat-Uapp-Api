...
public class ChatUappWebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(ChatUappResource),
                typeof(ChatUappDomainModule).Assembly,
    ...
    {
        context.Services.AddChatUappHealthChecks();
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<ChatUappWebModule>();
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<ChatUappWebModule>();

            if (hostingEnvironment.IsDevelopment())
            {
                options.FileSets.ReplaceEmbeddedByPhysical<ChatUappDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}ChatUapp.Domain.Shared", Path.DirectorySeparatorChar)));
                options.FileSets.ReplaceEmbeddedByPhysical<ChatUappDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}ChatUapp.Domain", Path.DirectorySeparatorChar)));
    ...
    private void ConfigureNavigationServices()
    {
        ...
        {
            options.MenuContributors.Add(new ChatUappMenuContributor());
        });

        Configure<AbpToolbarOptions>(options =>
        {
            options.Contributors.Add(new ChatUappToolbarContributor());
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(ChatUappApplicationModule).Assembly);
        });
    }
